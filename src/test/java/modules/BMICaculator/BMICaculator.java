...
public class BMICaculator {
    ...
    static void calculator(){
        ...
        BMIPageWay3 bmiPageWay3 = new BMIPageWay3(driver);
        bmiPageWay3.openMetricTab();
        bmiPageWay3.fillForm("34","Female", "147", "50");
        Assert.assertEquals( bmiPageWay3.getResult(),  "BMI = 23.1 kg/m2   (Normal)");
